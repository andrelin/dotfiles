...
The package list this repo ships with is in `conf/sublime-text/Package Control.sublime-settings`;
updating it there and re-running `dotfiles` keeps machines in sync.

## Tip 52.2: The `q` and `qq` Snippets
